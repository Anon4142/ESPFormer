...
class MultiHeadAttention(nn.Module):
    def __init__(self, d_model, n_heads):
        super().__init__()
        # Let EspAttention do all QKV stuff internally
        self.esp_attention = EspAttention(
            dim=d_model,
            heads=n_heads,
    ...
    def forward(self, x):
        ...
        """
        out, attn_map = self.esp_attention(x)
        return out, attn_map


class MultiHeadAttentionStandard(nn.Module):
    def __init__(self, d_model, n_heads):
        super(MultiHeadAttentionStandard, self).__init__()
        ...
        #self.scaled_dot_product_attn = EspAttention(self.d_k)
